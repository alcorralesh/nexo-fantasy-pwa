...
const demoData: FantasyBootstrapData = {
  ...
  leagues: [
    { id: "league_primera_publica", name: "Primera Abierta", competitionId: "comp_primera", competition: "Primera", mode: "market", rosterPolicy: "exclusive", type: "Pública · Mercado", rank: "—", members: "16/16", accent: "blue" },
    { id: "league_primera_privada", name: "Los del barrio", competitionId: "comp_primera", competition: "Primera", mode: "market", rosterPolicy: "exclusive", type: "Privada · Mercado", rank: "—", members: "8/10", accent: "lime" },
    { id: "league_primera_fantasy", name: "Fantástica Primera", competitionId: "comp_primera", competition: "Primera", mode: "fantasy", rosterPolicy: "repeatable", type: "Fantástica · Presupuesto", rank: "—", members: "14/16", accent: "violet" },
    { id: "league_segunda_publica", name: "Segunda Abierta", competitionId: "comp_segunda", competition: "Segunda", mode: "market", rosterPolicy: "exclusive", type: "Pública · Mercado", rank: "—", members: "12/16", accent: "blue" },
    { id: "league_segunda_privada", name: "La Peña de Plata", competitionId: "comp_segunda", competition: "Segunda", mode: "market", rosterPolicy: "exclusive", type: "Privada · Mercado", rank: "—", members: "7/10", accent: "lime" },
    { id: "league_segunda_fantasy", name: "Fantástica Segunda", competitionId: "comp_segunda", competition: "Segunda", mode: "fantasy", rosterPolicy: "repeatable", type: "Fantástica · Presupuesto", rank: "—", members: "11/16", accent: "violet" },
    { id: "league_f_publica", name: "Liga F Abierta", competitionId: "comp_liga_f", competition: "Liga F", mode: "market", rosterPolicy: "exclusive", type: "Pública · Mercado", rank: "—", members: "14/16", accent: "blue" },
    { id: "league_f_privada", name: "Reinas del Fútbol", competitionId: "comp_liga_f", competition: "Liga F", mode: "market", rosterPolicy: "exclusive", type: "Privada · Mercado", rank: "—", members: "9/10", accent: "lime" },
    { id: "league_f_fantasy", name: "Fantástica Liga F", competitionId: "comp_liga_f", competition: "Liga F", mode: "fantasy", rosterPolicy: "repeatable", type: "Fantástica · Presupuesto", rank: "—", members: "13/16", accent: "violet" },
  ],
  publicLeagues: [
