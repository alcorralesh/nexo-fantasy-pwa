-- El nombre es libre: "Clásicos de la jornada" es una liga de varios partidos, no un formato fijo.
...
begin
  ...
  if competition_count<>1 or season_count<>1 then raise exception 'Todos los partidos deben pertenecer a la misma competición y temporada'; end if;
